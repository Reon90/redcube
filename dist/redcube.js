...
var _quad = __webpack_require__(9);
...
var _env3 = __webpack_require__(8);

var _env4 = _interopRequireDefault(_env3);

var _blurEnv = __webpack_require__(6);

var _blurEnv2 = _interopRequireDefault(_blurEnv);

var _ssao = __webpack_require__(10);

var _ssao2 = _interopRequireDefault(_ssao);

var _blurSsao = __webpack_require__(7);
...
var RedCube = function () {
    ...
    _createClass(RedCube, [{
        ...
        value: function createEnvironment() {
            ...
            this.compileShader(gl.VERTEX_SHADER, _env4.default, program);
            this.compileShader(gl.FRAGMENT_SHADER, _blurEnv2.default, program);
        ...
        value: function postProcessing() {
            ...
            this.compileShader(gl.VERTEX_SHADER, _quad2.default, ssaoProgram);
            this.compileShader(gl.FRAGMENT_SHADER, _ssao2.default, ssaoProgram);
            ...
            this.compileShader(gl.VERTEX_SHADER, _quad2.default, ssaoBlurProgram);
            this.compileShader(gl.FRAGMENT_SHADER, _blurSsao2.default, ssaoBlurProgram);
        ...
        value: function buildSkin() {
            for (var k in this.json.skins) {
                ...
                try {
                    for (var _iterator4 = v.jointNames[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                        var join = _step4.value;
        ...
        value: function glInit() {
            ...
            try {
                for (var _iterator5 = this.scene.program[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                    var p = _step5.value;
        ...
        value: function animate(sec) {
            ...
            try {
                for (var _iterator7 = this.tracks[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                    var v = _step7.value;
        ...
        value: function render() {
            ...
            if (this.reflow) {
                ...
                if (nonBlends.length) {
                    ...
                    try {
                        for (var _iterator8 = nonBlends[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                ...
                if (blends.length) {
                    ...
                    try {
                        for (var _iterator9 = blends[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                    ...
                    if (blendsSorted.length) {
                        ...
                        try {
                            for (var _iterator10 = blendsSorted[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                                var _mesh = _step10.value;
        ...
        value: function _draw(mesh) {
            ...
            for (var _k5 in mesh.material.uniforms) {
                ...
                if (value.elements) {
                    ...
                    try {
                        for (var _iterator11 = matricies[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                            var m = _step11.value;
