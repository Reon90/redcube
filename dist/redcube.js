...
function canvasToWorld(x, y, projection, width, height) {
    ...
    newM.setTranslate.apply(newM, _toConsumableArray(new _matrix.Vector3([0, 0, 0.05]).elements));
    var m = new _matrix.Matrix4(projection);
    m.multiply(newM);
...
function calculateProjection(cam, aspect, zoom) {
    ...
    if (cam.type === 'perspective' && cam.perspective) {
        ...
        var aspectRatio = cam.perspective.aspectRatio || aspect;
        var xfov = yfov * aspect;

        if (aspect !== aspectRatio) {
            console.warn('this.canvas size and this.canvas size from scene dont equal');
        }

        proj = new _matrix.Matrix4().setPerspective(xfov * zoom * (180 / Math.PI), aspect, cam.perspective.znear || 1, cam.perspective.zfar || 2e6);
...
var _env3 = __webpack_require__(12);

var _env4 = _interopRequireDefault(_env3);

var _blurEnv = __webpack_require__(10);
...
var Parse = exports.Parse = function () {
    ...
    _createClass(Parse, [{
        ...
        key: 'setCamera',
        value: function setCamera(camera, aspect, zoom) {
            this._camera = camera;
            this.aspect = aspect;
            this.zoom = zoom;
        }
        ...
        value: function buildPrim(parent, source, name, p) {
            ...
            if (isBlend) {
                ...
                try {
                    for (var _iterator3 = technique.states.enable[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                        var e = _step3.value;
                ...
                try {
                    for (var _iterator4 = technique.states.enable[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                        var _e = _step4.value;
        ...
        value: function walkByMesh(parent, name) {
            ...
            if (el.camera) {
                var proj = (0, _utils.calculateProjection)(this.json.cameras[el.camera], this.aspect, this.zoom);
        ...
        value: function buildMesh() {
            ...
            this.json.scenes.defaultScene.nodes.forEach(function (n) {
                ...
                if (_this3.json.nodes[n].camera) {
                    var proj = (0, _utils.calculateProjection)(_this3.json.cameras[_this3.json.nodes[n].camera], _this3.aspect, _this3.zoom);
        ...
        value: function buildSkin() {
            for (var k in this.json.skins) {
                ...
                try {
                    for (var _iterator5 = v.jointNames[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
var _quad = __webpack_require__(13);
...
var _bloom = __webpack_require__(8);

var _bloom2 = _interopRequireDefault(_bloom);

var _ssao = __webpack_require__(14);

var _ssao2 = _interopRequireDefault(_ssao);

var _blurSsao = __webpack_require__(11);
...
var _postprocessing = __webpack_require__(6);
...
var RedCube = function () {
    ...
    _createClass(RedCube, [{
        key: 'init',
        value: function init() {
            return this.parse.getJson().then(this.glInit.bind(this)).then(this.parse.loadShader.bind(this.parse)).then(this.PP.buildScreenBuffer.bind(this.PP)).then(this.parse.getBuffer.bind(this.parse)).then(this.parse.buildMesh.bind(this.parse)).then(this.parse.initTextures.bind(this.parse)).then(this.parse.buildAnimation.bind(this.parse)).then(this.parse.buildSkin.bind(this.parse)).then(this.env.createEnvironmentBuffer.bind(this.env)).then(this.draw.bind(this)).catch(console.error);
        }
    }, {
        key: 'setColor',
        ...
        value: function redraw(type, coordsStart, coordsMove) {
            if (type === 'zoom') {
                ...
                this._camera.setProjection((0, _utils.calculateProjection)(this._camera.props, this.aspect, this.zoom).elements);
            }
            if (type === 'rotate') {
                var p0 = new _matrix.Vector3((0, _utils.sceneToArcBall)(_utils.canvasToWorld.apply(undefined, _toConsumableArray(coordsStart).concat([this._camera.projection, this.canvas.offsetWidth, this.canvas.offsetHeight]))));
                var p1 = new _matrix.Vector3((0, _utils.sceneToArcBall)(_utils.canvasToWorld.apply(undefined, _toConsumableArray(coordsMove).concat([this._camera.projection, this.canvas.offsetWidth, this.canvas.offsetHeight]))));
            ...
            if (type === 'pan') {
                var _p = new _matrix.Vector3(_utils.canvasToWorld.apply(undefined, _toConsumableArray(coordsStart).concat([this._camera.projection, this.canvas.offsetWidth, this.canvas.offsetHeight])).elements);
                var _p2 = new _matrix.Vector3(_utils.canvasToWorld.apply(undefined, _toConsumableArray(coordsMove).concat([this._camera.projection, this.canvas.offsetWidth, this.canvas.offsetHeight])).elements);
        ...
        value: function animate(sec) {
            ...
            try {
                for (var _iterator = this.parse.tracks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var v = _step.value;
        ...
        value: function render() {
            ...
            if (this.reflow) {
                ...
                if (nonBlends.length) {
                    ...
                    try {
                        for (var _iterator2 = nonBlends[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                if (blends.length) {
                    ...
                    try {
                        for (var _iterator3 = blends[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                            var _mesh2 = _step3.value;
                    ...
                    if (blendsSorted.length) {
                        ...
                        try {
                            for (var _iterator4 = blendsSorted[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        ...
        value: function _draw(mesh) {
            ...
            for (var _k in mesh.material.uniforms) {
                ...
                if (value.elements) {
                    ...
                    try {
                        for (var _iterator5 = matricies[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                            var m = _step5.value;
